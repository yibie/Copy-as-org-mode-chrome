...
/** Strong typed version ChangeDict for WebExtension (e.g. chrome.storage.onChanged).
...
/**
 * Type-safe version of Object.assign that ensures both target and source have the same type
 * @param target The target object to copy properties to
 * @param newValue The source object to copy properties from
 * @returns The modified target object
 */
export function objectAssignPerfectly<T extends object>(target: T, newValue: T): T {
    return Object.assign({}, target, newValue) as T
}
...
export function storageSetSync<T extends object>(d: T): void {
